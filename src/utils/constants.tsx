export const books = [
  ...
  {
    id: 2,
    title: 'Caderno de Língua Portuguesa',
    duration: 0,
    questions: [
      {
        id: 201,
        ...
        description: "Classifique o sujeito da frase: 'O gato preto dorme no sofá.'",
        answer: '',
        duration: 0,
      },
      {
        ...
        description: 'Qual é a ideia principal do texto fornecido?',
        answer: '',
        duration: 0,
      },
    ],
    ...
    questions: [
      {
        ...
        idBook: 3,
        title: 'Ciclo da Água',
        description: 'Explique as etapas do ciclo da água.',
        answer: '',
        duration: 0,
      },
      {
